...
@section('content')
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('store.instruktur') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="spesialisasi" value="{!! old('spesialisasi') !!}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
