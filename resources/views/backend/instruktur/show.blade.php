...
@section('content')
    <div class="mb-3">
        <a href="{{ route('index.instruktur') }}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
    </div>
    <h3 class="text-dark mb-4">Detail Data Instruktur</h3>
    @if (session('message'))
