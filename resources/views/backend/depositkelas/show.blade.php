    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tr>
                            <th>Deposit</th>
                            <th>{{ $data->total_deposit }} ( {{$data->jangka_waktu}}x{{ $data->biaya_kelas }} )</th>
                        </tr>
                        <tr>
                            <th>Jenis Kelas</th>
                        ...
                        <tr>
                            <th>Total Deposit {{ $data->nama_kelas }}</th>
                            <th>{{ $data->jangka_waktu }}</th>
                        </tr>
                        <tr>
            ...
            <div class="text-right p-2">
                <a href="{{ route('print.depositkelas', ['id' => $id]) }}" target="_blank" class="btn btn-sm btn-primary"><i class="fas fa-print" title="Print Member" style="--bs-primary: #094067;--bs-primary-rgb: 9,64,103;"></i> Cetak Struk</a>
            </div>
        </div>
    </div>
