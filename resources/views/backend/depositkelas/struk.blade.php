...
<div class="card">
    ...
    <table>
        ...
        <tr>
            ...
            <th style="text-align: left;"><p> : </p></th>
            <th style="text-align: left;"><p> {{ $data->total_deposit }} ( {{$data->jangka_waktu}}x{{ $data->biaya_kelas }} ) </p></th>
        </tr>
        <tr>
            <th style="text-align: left;"><p>Jenis Kelas</p></th>
            <th style="text-align: left;"><p> : </p></th>
            <th style="text-align: left;"><p> {{ $data->nama_kelas }} </p></th>
        </tr>
        <tr>
            <th style="text-align: left;"><p>Total Deposti {{ $data->nama_kelas }}</p></th>
            <th style="text-align: left;"><p> : </p></th>
            <th style="text-align: left;"><p> {{ $data->jangka_waktu }} </p></th>
        </tr>
        <tr>
            <th style="text-align: left;"><p>Berlaku Sampai Dengan</p></th>
            <th style="text-align: left;"><p> : </p></th>
            <th style="text-align: left;"><p> {{ $data->expired }} </p></th>
        </tr>
    </table>
    <br>
    <hr>
