...
@section('content')
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('update.member', $data->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <img class="card-img-top" style="width: 300px; height: auto" src="@if (empty($data->photo))
